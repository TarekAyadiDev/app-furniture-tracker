...
export const ITEM_TRACKED_FIELDS: TrackedFieldSpec<Item>[] = [
  ...
  { field: "discountType", get: (i) => i.discountType, normalize: normalizeOptionalString },
  { field: "discountValue", get: (i) => i.discountValue, normalize: normalizeOptionalNumber },
...
export const OPTION_TRACKED_FIELDS: TrackedFieldSpec<Option>[] = [
  ...
  { field: "discountType", get: (o) => o.discountType, normalize: normalizeOptionalString },
  { field: "discountValue", get: (o) => o.discountValue, normalize: normalizeOptionalNumber },
